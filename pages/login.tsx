	...
	return (
		<Layout title="Log in to Spotify">
			<div className="flex h-screen w-screen flex-col items-center justify-center gap-20">
				...
				/>
				<button
					className="relative flex rounded-full bg-primary px-12 py-2 text-lg uppercase tracking-widest hover:bg-primary/80 hover:bg-opacity-80 focus:outline-none h-12 items-center justify-center"
					onClick={handleLogin}
					disabled={isLoading}
					type="button"
				>
